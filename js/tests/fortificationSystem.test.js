...
const testFortificationCard =
  createCard("hearts", "7");

const testNextWallCard =
  createCard("clubs", "4");
...
// Assign Authoritative Active Wall State

testPlayer.activeWallState =
  testWallState;
...
console.log(
  "Tower After Fortified Wall Destruction:",
  testPlayer.tower.length,
);

console.log(
  "Dead Pile After Fortified Wall Destruction:",
  testDeadPile.length,
);

console.log(
  "Destroyed Wall Fortification:",
  testWallState.fortification,
);
...
const damageWallCard =
  createCard("hearts", "7");

const damageFortificationCard =
  createCard("clubs", "7");
...
const penetrationWallCard =
  createCard("hearts", "7");

const penetrationFortificationCard =
  createCard("clubs", "7");

const penetrationWall =
  createWallState(
    penetrationWallCard,
  );
